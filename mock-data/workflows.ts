...
// 种子派生副本：由 wf-2（采购合同审批）派生，编号已重排、版本历史为空、溯源映射完整
const seededDerivation=deriveWorkflow(base[1],{newId:'wf-101',name:'采购合同审批（华东区）',now:new Date('2026-07-09T10:20:00'),editor:'陈默'});
seededDerivation.updatedAt='2026-07-09 10:20';
seededDerivation.abnormalCount=0;
export const workflows:Workflow[]=[seededDerivation,...base];
